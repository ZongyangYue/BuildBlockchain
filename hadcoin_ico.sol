...
contract hadcoin_ico {
    ...
    //Mapping from the investor's address to its equity in Hadcoins and USD
    mapping(address => uint) public equity_hadcoins;
